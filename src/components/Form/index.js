...
function Form() {
  ...
  return (
    <div className="d-flex flex-column align-items-center w-50 h-50 mt-4">
      ...
      <button onClick={ApiCall} className="btn bg-gradient-danger mt-4" aria-label="Button to submit user question" style={{ fontSize: "20px" }}>Submit!</button>

      {/* Button that links to the history page */}
      <a href="/history" className="btn bg-gradient-secondary mt-4" role="button" aria-label="Button to see last searched question on a new page" style={{ fontSize: "20px" }}>History</a>
